...
export class ProductsComponent {
  products: UserProduct[] = [
    {
      image:
        'https://www.giardiniblog.it/wp-content/uploads/2022/05/immagine-tramonto-gratis.jpg',
      name: 'Prodotto 1',
    ...
    {
      image:
        'https://cdn.pixabay.com/photo/2022/07/05/11/06/mountains-7302806__480.jpg',
      name: 'Prodotto 2',
    ...
    {
      image:
        'https://tse2.mm.bing.net/th/id/OIP.4nY4Ys05hzDoNVpPJemNHwHaEo?r=0&rs=1&pid=ImgDetMain&o=7&rm=3',
      name: 'Prodotto 3',
